<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Question_5.aspx.cs" Inherits="Question_5" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
      <p style="margin-left: 60px; font-size: 30px; width: 993px;">
          5. In .NET there are five fundamental data types. Describe the Class type. What does the constructor of a class type do? What is the difference between an instance constructor and a static constructor? Describe how you can use the this keyword in a constructor. Describe how you would create an instance of an object. </p>
<p>
...
<p>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:TextBox id="TextBox_1" TextMode="multiline" Columns="150" Rows="30" AutoPostBack="true"   cssclass="NoScroll" runat="server"  style="margin-left: 38px;OVERFLOW: hidden;" Height="629px" Width="997px" Visible="False" />
    </p>
    <br />
    <br />
