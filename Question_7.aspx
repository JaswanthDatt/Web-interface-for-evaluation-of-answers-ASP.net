<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Question_7.aspx.cs" Inherits="Question_7" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
      <p style="margin-left: 60px; font-size: 30px; width: 993px;">
           7. Describe polymorphism in C#. What does the virtual keyword do? What does the override keyword do? What does the sealed keyword do when applied to a virtual member? What is an abstract class?</p>
<p>
...
<p>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:TextBox id="TextBox_1" TextMode="multiline" Columns="150" Rows="30" AutoPostBack="true"   cssclass="NoScroll" runat="server"  style="margin-left: 38px;OVERFLOW: hidden;" Height="667px" Width="987px" Visible="False" />
    </p>
      <p>
          &nbsp;</p>
    <br />
