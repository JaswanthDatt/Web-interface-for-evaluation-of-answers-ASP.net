<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Question_9.aspx.cs" Inherits="Question_9" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
      <p style="margin-left: 60px; font-size: 30px; width: 993px;">
           9. What is WPF? What is XAML (“zammel”)? Describe the Application class as used in a WPF application? Describe the Window class as used in a WPF application? Discuss what a layout manager is and what it is used for.</p>
<p>
...
<p>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:TextBox id="TextBox_1" TextMode="multiline" Columns="150" Rows="30" AutoPostBack="true"   cssclass="NoScroll" runat="server"  style="margin-left: 38px;OVERFLOW: hidden;" Height="604px" Width="994px" Visible="False" />
    </p>
    <br />
    <br />
