<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Question_3.aspx.cs" Inherits="Question_3" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
     <p style="margin-left: 60px; font-size: 30px; width: 993px;">
           3.Of the intrinsic data types in C#,there are  14 primitive data types.Name each one.What is the difference between  value type and reference type.
</p>
<p>
...
<p>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:TextBox id="TextBox_1" TextMode="multiline" Columns="150" Rows="30" AutoPostBack="true"   cssclass="NoScroll" runat="server"  style="margin-left: 38px;OVERFLOW: hidden;" Height="608px" Width="984px" Visible="False" />
    </p>
     <p>
         &nbsp;</p>
    <br />
